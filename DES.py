...
def generate_keys(key):
    ...
    for shift in SHIFTS:
        ...
        subkey = permute(combined, PC2, 56)
...
def make_block(text):
    ...
    return int.from_bytes(text[:8].encode(), "big")
...
for i in range(0, len(plaintext), 8):
    ...
    block_text = plaintext[i:i+8]

    block = make_block(block_text)
